...
export excel "$out/ResultadosLocalLinearPrimario", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearPrimario.xls", modify
...
export excel "$out/ResultadosLocalLinearPrimario", sheetmodify cell(A4)
restore
