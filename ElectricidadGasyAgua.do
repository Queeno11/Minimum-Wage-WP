...
gen luz=(secto5==1|secto9==1)
replace luz=. if letra==""
...
export excel "$out/ResultadosLocalLinearLuz", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearLuz.xls", modify
...
export excel "$out/ResultadosLocalLinearLuz", sheetmodify cell(A4)
restore
