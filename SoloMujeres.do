...
export excel "$out/ResultadosLocalLinearMujeres", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearMujeres.xls", modify
...
export excel "$out/ResultadosLocalLinearMujeres", sheetmodify cell(A4)
restore
