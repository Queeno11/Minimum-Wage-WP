...
export excel "$out/ResultadosLocalLinear", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinear.xls", modify
...
export excel "$out/ResultadosLocalLinear", sheetmodify cell(A4)
restore
