...
export excel "$out/ResultadosLocalLinearNoGBA", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearNoGBA.xls", modify
...
export excel "$out/ResultadosLocalLinearNoGBA", sheetmodify cell(A4)
restore
