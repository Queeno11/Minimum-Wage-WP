...
gen manu=(secto4==1|secto6==1)
replace manu=. if letra==""
...
export excel "$out/ResultadosLocalLinearManuyCons", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearManuyCons.xls", modify
...
export excel "$out/ResultadosLocalLinearManuyCons", sheetmodify cell(A4)
restore
