...
export excel "$out/ResultadosLocalLinearGBA", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearGBA.xls", modify
...
export excel "$out/ResultadosLocalLinearGBA", sheetmodify cell(A4)
restore
