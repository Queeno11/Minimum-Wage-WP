...
export excel "$out/ResultadosLocalLinearHombres", sheetmodify cell(A`c')
restore
...
local c=`c'+4
 ...
 putexcel set "$out/ResultadosLocalLinearHombres.xls", modify
...
export excel "$out/ResultadosLocalLinearHombres", sheetmodify cell(A4)
restore
